...
public class CategoryResult {
	...
	public static class Info extends Name {
		...
		public static Info of(MentoringCategory mentoringCategory) {
			return new Info(mentoringCategory.getMentoringCategoryId()
					.categoryId(), mentoringCategory.getName(), mentoringCategory.getCode(),
					mentoringCategory.getSortOrder(), mentoringCategory.isActive());
		}
