...
class CategoryServiceTest {
  ...
  void getActiveCategories_returns_mapped_results() {
    ...
    assertThat(result.get(0).getName()).isEqualTo(c1.getName());
    assertThat(result.get(0).getCode()).isEqualTo(c1.getCode());
    assertThat(result.get(0).getSortOrder()).isEqualTo(0);
    assertThat(result.get(0).isActive()).isTrue();
    assertThat(result.get(1).getName()).isEqualTo(c2.getName());
  }
  ...
  void getAllCategories_success_when_master() {
    ...
    assertThat(result.get(1).getSortOrder()).isNull();
  }
